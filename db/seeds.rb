...
Orchestra.create!(name: "Fort Collins Symphony Orchestra", chairs: 10, conductor: "Group led", active: true, venue: true)
...
Musician.create!(name: "Joe -Doesn't play anymore- Roberts", instruments: "guitar", songs: 0, on_call: false, orchestra_id: 1)